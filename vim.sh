...
# format paragraphs in vi (width = 72)
!}fmt -w 72
...
# insert "this" at the begining of every line
:%s/^/this/g

# insert "this" at the end of every line
:%s/$/this/g

--[ copied from the vilearn tutorial
